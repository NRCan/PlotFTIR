...
This will display the spectral range, inferred resolution, intensity type, number of samples, and sample IDs.
...
Vous pouvez examiner la structure de vos données à l'aide de la méthode d'impression :

```{r print_data_fr}
print(biodiesel)
```

Ceci affichera la plage spectrale, la résolution inférée, le type d'intensité, le nombre d'échantillons et les identifiants des échantillons.

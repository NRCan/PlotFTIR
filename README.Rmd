...
Some FTIR plots have a compressed low-energy portion of the graph. We can achieve this by the following:
...
Certains tracés FTIR ont une partie compressée du graphique à faible énergie. Nous pouvons y parvenir de la manière suivante :

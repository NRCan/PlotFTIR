...
```{r biodiesel_labelled_en, fig.cap="FTIR spectra of biodiesel samples, with vertically aligned peak labels at 1742 and 1710 cm-1 and a coloured band from 3050 to 2750 for C-H stretch."}
...
```{r biodiesel_labelled_fr, fig.cap="Spectres FTIR d'échantillons de biodiesel, avec des étiquettes de pics alignées verticalement à 1742 et 1710 cm-1, et une bande colorée de 3050 à 2750 pour l'élongation C-H."}

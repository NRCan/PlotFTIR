# Extracted from test-raman_utils.R:124
...
test_that("enforces minimum distance between detected peaks", {
    ...
    peak2 <- 100 * exp(-(wn - 510)^2 / 500)
    peak3 <- 100 * exp(-(wn - 600)^2 / 500)
...
test_that("errors when intensity attribute is not set to raman", {
    wn <- seq(100, 2000, by = 5)

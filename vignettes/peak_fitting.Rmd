...
The output shows the fitted parameters for each peak: wavenumber location (`wavenumber`), width (`sigma`), shape parameter (`eta`), and relative contribution (`mix_ratio`). The Voigt fit found large peaks at approximately 1457, 1378, and 1366 cm⁻¹ — these correspond to known C-H bending and C-C stretching vibrations in hydrocarbon chains.

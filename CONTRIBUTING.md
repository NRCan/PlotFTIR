...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("NRCan/PlotFTIR", fork = TRUE)`.
...
- You can use the [styler](https://CRAN.R-project.org/package=styler)
  package to apply code styles, but please don’t restyle code that has
...
Code of Conduct](https://nrcan.github.io/PlotFTIR/CODE_OF_CONDUCT.md).

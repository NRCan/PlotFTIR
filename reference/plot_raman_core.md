...
Plot the Raman spectra in a journal prepared format. Call
\[plot_raman()\] for basic (overlaid) plots and \[plot_raman_stacked()\]
for stacked and offset plots.

Tracez les spectres Raman dans un format préparé par un journal.Appelez
\[plot_raman()\] pour les tracés de base (superposés) et
\[plot_raman_stacked()\] pour les tracés empilés et décalés.

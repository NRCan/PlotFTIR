...
#'   `zoom_range`.
#'
#'   le tracé FTIR en tant qu'objet ggplot2, avec des limites d'axe x comme celles fournies par `zoom_range`.
#'
#' @export
#'
#' @examples
...
#'
#' @description Add a vertical line marker at a given wavenumber, and label at
#'  the top of the plot with a provided text (or default the wavenumber of the
#'  marker). This is useful for noting important wavenumbers.
#'
#'  This function can be called repeatedly. Note that older labels will be
#'  overwritten by newer labels.
#'
#'  Ajoutez un marqueur de ligne verticale à un numéro d'onde donné et étiquetez
#'  en haut du tracé avec un texte fourni (ou par défaut le numéro d'onde du
#'  marqueur). Ceci est utile pour noter les nombres d’onde importants.
#'
...
#'
#'  le tracé FTIR en tant qu'objet ggplot2, avec un marqueur ajouté au numéro
#'  d'onde spécifié.
#'
